...
export default function AboutUsSection() {
  ...
  return (
    <section className="bg-orange-50 py-12 px-4 md:py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-2 mb-4">
              <span className="text-orange-500 font-medium text-sm md:text-base">About Us</span>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-2xl md:text-3xl font-bold text-orange-500">1980+</p>
                </div>
              </div>
