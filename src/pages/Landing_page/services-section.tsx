      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-2 mb-4">
            <span className="text-orange-500 font-medium">Our Service</span>
        ...
        <div className="relative">
          ...
          <div className="block lg:hidden space-y-8">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-lg border border-orange-200">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-3">Pet Taxi 24/7</h3>
          ...
          <div className="hidden lg:block relative min-h-[600px]">
            ...
            <div className="absolute top-0 left-0 w-80 bg-white rounded-full p-8 shadow-lg border-2 border-orange-200">
              <div className="text-center">
        ...
        <div className="text-center mt-12 lg:mt-20">
          <button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-full text-lg font-medium shadow-lg">
            VIEW SERVICES
